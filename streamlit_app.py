...
st.title("The Startups dataset")
st.markdown(
    "The dataset contains modifications with regards to the original for illustrative & learning purposes"
)

Administration = st.slider('How many administrations does the listing have?', 0, 50, 20)
...
user_input = [[Administration]]#, accommodates, instant_bookable]]
